#pragma once
/*
 * Tệp này chứa các định nghĩa cấu trúc dữ liệu cần thiết cho tương tác với Windows kernel
 */

// Cờ cho NtCreateProcessEx
