# Process Doppelgänging: Kỹ Thuật Tấn Công Ẩn Danh Tiên Tiến

<div align="center">
  <img src="https://blog.malwarebytes.com/wp-content/uploads/2018/08/dopel1_.png" alt="Process Doppelgänging Technique Diagram" width="650px"/>
  <p><em>Sơ đồ minh họa kỹ thuật Process Doppelgänging</em></p>
...
> **Lưu ý quan trọng**: Phiên bản 32-bit chỉ hoạt động đúng trên hệ thống 32-bit. Trên hệ thống 64-bit, vui lòng sử dụng phiên bản 64-bit để đảm bảo tương thích.
...
```
process_doppelganging.exe <đường_dẫn_payload> [*đường_dẫn_đích]
```

Trong đó:

- `<đường_dẫn_payload>`: Đường dẫn đến tệp thực thi PE (EXE, DLL) cần thực thi ẩn danh
...
```
process_doppelganging.exe C:\path\to\payload.exe
```

Hoặc với đường dẫn đích cụ thể:

```
process_doppelganging.exe C:\path\to\payload.exe C:\Windows\System32\notepad.exe
```
...
Các đóng góp cho dự án này được hoan nghênh! Nếu bạn muốn tham gia:
...
[![GitHub](https://img.shields.io/badge/GitHub-fu0nd41-181717?style=flat-square&logo=github)](https://github.com/fu0nd41)
